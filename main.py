...
game_object = GameObject("Knife", "Somewhat rusty, but still sharp.",
                         "Cold to the touch, but not too heavy.",
                         "It smells of metal and a hint of blood.")
...
class Game:
    ...
    def interact_with_object(self, object, interaction):
        if interaction == "1":
            ...
            return "Invalid interaction. Please try again."
